export default function AdaptivePage() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-start gap-3 rounded-2xl border border-border bg-background p-8">
      ...
      <h1 className="font-display text-2xl font-bold">Adaptive AI Tests</h1>
      <p className="text-sm text-text-soft">
        This module is scaffolded in the route structure and ready to be built out — full Adaptive AI Tests functionality
